...
import com.jluque.batch.listener.JobListener;
import com.jluque.batch.model.Persona;
import com.jluque.batch.processor.PersonaItemProcessor;
...
public class BatchConfiguration {
    ...
    @Bean
    public Step step1(JdbcBatchItemWriter<Persona> writer, JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    ...
    @Bean
    public Job importPersonaJob(JobListener listener, Step step1, JobRepository jobRepository) {
